...
#import "FTAwesomeButton.h"

@interface FTAwesomeButton ()
...
@implementation FTAwesomeButton
@synthesize iconImageView = _iconImageView;

+(FTAwesomeButton*)buttonWithType:(UIButtonType)type text:(NSString *)text iconImage:(UIImage *)icon attributes:(NSDictionary *)attributes andIconPosition:(IconPosition)position
{
    FTAwesomeButton *button = [[FTAwesomeButton alloc] initWithFrame:CGRectZero text:text iconImage:icon attributes:attributes andIconPosition:position];
    return button;
}

+(FTAwesomeButton*)buttonWithType:(UIButtonType)type text:(NSString *)text icon:(NSString *)icon attributes:(NSDictionary *)attributes andIconPosition:(IconPosition)position
{
    FTAwesomeButton *button = [[FTAwesomeButton alloc] initWithFrame:CGRectZero text:text icon:icon attributes:attributes andIconPosition:position];
    return button;
}
...
-(void)updateSubviewsContent
{
    ...
    if (self.backImg) {
        [self.backgroundImageView setImage:self.backImg];
    }
}
...
-(UIImageView*) backgroundImageView
{
    if(!self.backgroundImageView) {
        ...
        [self.backgroundImageView setContentHuggingPriority:UILayoutPriorityRequired forAxis:UILayoutConstraintAxisVertical];
        [self.backgroundImageView setContentCompressionResistancePriority:UILayoutPriorityRequired forAxis:UILayoutConstraintAxisVertical];
...
- (void) setbackgroundImage:(NSString *)imgString {
    _backImg = [UIImage imageNamed:imgString];
}
