...
- (void)viewDidLoad
{
    ...
    CGRect frame = CGRectMake(0, 60, self.view.bounds.size.width, self.view.bounds.size.height);
    
	self.webView=[[CreditWebView alloc]initWithFrame:frame andUrl:[[self.request URL] absoluteString]];
